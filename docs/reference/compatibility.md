...
specification package when consuming JSON. These commands select the verified beta.3 public preview.

| Task | Install |
| --- | --- |
| Read documents in Python | `python -m pip install "agent-topology-spec==0.1.0b3"` |
| Extract Python LangGraph graphs or use `agt` | `python -m pip install "agent-topology-langgraph==0.1.0b3"` |
| Read documents in Node.js | `npm install @agent-topology/spec@0.1.0-beta.3` |
| Extract LangGraph.js graphs | `npm install @agent-topology/spec@0.1.0-beta.3 @agent-topology/langgraph@0.1.0-beta.3` |
...
See [release notes](../releases/v0.1.0-beta.3.md) for published artifact identities,
